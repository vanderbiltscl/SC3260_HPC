...
| Introduction to C++ | 01/22 | [IntroC.pdf](lectures/2_cpp.pdf) | C extensions for Python: https://cython.org/ |
|  | | | Code examples and documentation in the `C_code_examples` folder |
|  | | | Instructions on running the code: Comming soon |
